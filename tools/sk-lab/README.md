...
- `fall <dir> <room> <x> <y> [input] [frames]`: stands Blob somewhere with one input held and prints where he goes. Standing with his top cell in room row R reads `y = 143 - 8R`.
