...
**For development only**, the local checks under `games/starquake/` can use, when given their paths:

| File | What | Used by |
|---|---|---|
| `starquake.tap` | Starquake (Bubble Bus, 1985), SHA-1 `65450d6f33692c2c2868c0b497037f2cfd0ef3bd` | every local check |
| `48.rom` | ZX Spectrum 48K ROM, SHA-1 `5ea7c2b824672e914525d1d5c419d71b84a426a2` | only the check that answering the three ROM calls matches the real ROM (`games/starquake/docs/rom.md`) |
