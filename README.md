...
- [ ] Training mode's four switches: time stands still, full gun and platforms, endless lives, no harm from enemies; each written back between frames while it is on, and named on the game's score (built; awaiting a check by hand).
