...
- [ ] Guidance level 1: the codes of the teleporters whose booths you have entered, listed in the panel (built; awaiting a check by hand). Levels 2 to 5 and training mode are still to come.
