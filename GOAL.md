...
5. **No ROM file.** Starquake enters the ROM at only three addresses, and the program answers those calls itself. `docs/rom.md` holds the evidence and the decision.
...
- Every step of `PLAN.md` committed and pushed.
