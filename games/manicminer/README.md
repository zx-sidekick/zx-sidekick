...
- [x] Guidance level 4 (#155), the jump preview: where a jump would land, or that it would kill Willy, drawn on the panel's cavern: left, straight up and right while he stands still, and the way he walks and straight up while he walks. The game itself answers, run on a copy of the machine with the switches in force, on a thread of its own so play never waits for it (checked by hand by the maintainer, 2026-09-23)
